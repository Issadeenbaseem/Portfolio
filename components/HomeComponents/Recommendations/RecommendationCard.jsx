    ...
    return (
        <CardLayout>
            <div className="p-8 h-full relative card_stylings transition">
                ...
                <div className="text-xs text-LightGray italic mt-1">{designation}</div>
                <div className="text-sm mt-2 text-LightGray font-normal">{view}</div>
            </div>
        </CardLayout>
    );
};
